...
def setCsvData(uid, slave_id, registers, timesend, vers):
    ...
    sdata = {
        "uvid": uid,
        "slave": slave_id,
        "pv1_voltage": int(registers.get(45056)[5]["value"])/100,
        "pv2_voltage": int(registers.get(45059)[5]["value"])/100,
        "pv3_voltage": int(registers.get(45062)[5]["value"])/100,
        "pv1_current": int(registers.get(45057)[5]["value"])/100,
        "pv2_current": int(registers.get(45060)[5]["value"])/100,
        "pv3_current": int(registers.get(45063)[5]["value"])/100,
        "pv1_power": int(registers.get(45058)[5]["value"])/100,
        "pv2_power": int(registers.get(45061)[5]["value"])/100,
        "pv3_power": int(registers.get(45064)[5]["value"])/100,
        "daily_energy": int(registers.get(1071)[5]["value"])/100,
